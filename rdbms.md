...
<br>2 . Add a file called yourname_sqlchallenges.md to the [RDBMS 16-17](https://github.com/aammeloot/RDMS16-17) repository with an SQL challenge for your fellow students. Make sure you have a solution to the challenge and if the challenge requires any other knowledge other than that presented in class, you must indicate what else is required in your challenge.
